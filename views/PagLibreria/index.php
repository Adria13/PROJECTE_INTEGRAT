...
<head>
	...
	<link rel="stylesheet" href="../views/PagLibreria/css/style.css">
	<link rel="stylesheet" href="../views/css/icomoon.css">
	<link rel="stylesheet" href="../views/css/barraMenu.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script src="../views/PagLibreria/js/cargarMas.js"></script>
	<script src="../views/js/buscar.js"></script>
</head>
<body>
	<header>
		...
		<div id="content">
				...
				<div id="boton">
					<button id="cargar">Ver más libros</button>
				</div>
